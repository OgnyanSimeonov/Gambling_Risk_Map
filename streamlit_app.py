...
with tab1:
    ...
    # CHANGED: root-relative path instead of hardcoded localhost.
    # This resolves correctly whether the app runs locally or on Streamlit Cloud,
    # since Streamlit serves everything under one domain.
